...
static bool xxx_fuzzy_match(char const *str, char const *pattern, int *outScore) {
...
static bool fuzzy_match(char const *str, char const *pattern, int *outScore) {
	const int adjacency_bonus = 5;              // bonus for adjacent matches
	const int separator_bonus = 10;             // bonus if match occurs after a separator
	const int camel_bonus = 10;                 // bonus if match is uppercase and prev is lower
...
int main(int argc, char const *argv[]) {
	// const char *str = "writer";
	// const char *pattern = "go_cairo_writer";
	const char *str = "∆∆∆";
	const char *pattern = "∆∆∆";
	int score = 0;
	fuzzy_match(pattern, str, &score);
	printf("%d\n", score);
	return 0;
}
